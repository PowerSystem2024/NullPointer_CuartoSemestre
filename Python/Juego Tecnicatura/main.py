...
def main() :
    ...
    ultimo_disparo = 0
    tiempo_disparo = 200  # 200 milisegundos (0.2 segundos) de espera entre disparos
    ...
    while running :
        ...
        if keys[pygame.K_SPACE] and tiempo_actual - ultimo_disparo > tiempo_disparo:
            personaje.lanzar_laser()
            sonido_laser.play()
            ultimo_disparo = tiempo_actual  # Actualizar el momento del último disparo
        ...
        for enemigo in enemigos [ : ] :  # Iterar sobre una copia para eliminar de la lista original
            ...
            if enemigo.rect.colliderect ( personaje.shape ) :
                ...
                # Elimina al enemigo después de la colisión para que no cause más daño
                enemigos.remove ( enemigo )
